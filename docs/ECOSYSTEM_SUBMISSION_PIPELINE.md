...
| GitHub repository and Releases | Developer credibility, changelog, install entry | **READY**: npm `0.1.1` and its clean-room import are verified | Create a factual `sdk-v0.1.1` release with the exact install command and current public-preview limitations |
