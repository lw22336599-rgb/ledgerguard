...
| **Mainnet** | Mainnet stays disabled until documented release gates pass. Base canary is bounded and optional. | "Live on Arc Mainnet" / "Open for real USDC today" | Arc Mainnet off (official params); Base mainnet needs 6 env gates + human approval phrase. |
